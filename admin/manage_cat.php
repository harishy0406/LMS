...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd">
		...
		<center><h4 style="font-size: 2rem; color:rgb(250, 250, 250);font-weight: bold;">Manage Category</h4><br></center>
		<div class="row">
							...
							<tr>
								...
								<td>
									<button class="btn btn-edit">
										<a href="edit_cat.php?cid=<?php echo $row['cat_id']; ?>">Edit</a>
									</button>
									<button class="btn btn-delete">
										<a href="delete_cat.php?cid=<?php echo $row['cat_id']; ?>">Delete</a>
									</button>
								</td>
